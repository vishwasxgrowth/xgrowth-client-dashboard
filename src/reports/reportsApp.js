...
(function () {
  ...
  var embeddedReportTheme = '<style>' +
    ':root{--bg:transparent;--card:#FFFFFF;--card-2:#F7F7F3;--soft:#E7E7E0;--text:#0E0F0C;--ink:#0E0F0C;--ink-soft:#475569;--ink-faint:#64748B;--mut:#64748B;--bd:#E2E8F0;--line:#E2E8F0;--accent:#0343EF;--accentbg:rgba(3,67,239,.10);--up:#15803D;--up-bg:rgba(21,128,61,.12);--upbg:rgba(21,128,61,.12);--down:#B91C1C;--down-bg:rgba(185,28,28,.12);--downbg:rgba(185,28,28,.12);--breach-bg:rgba(185,28,28,.10);--breach-line:rgba(185,28,28,.34);--dx-monet:#B45309;--dx-traffic:#0343EF;--dx-tech:#6D3E75;--growth-bg:rgba(21,128,61,.12);--growth-ink:#15803D;--mod-bg:rgba(185,28,28,.12);--mod-ink:#B91C1C;--shadow:0 8px 22px rgba(14,15,12,.06);}' +
    ':root[data-theme="dark"]{--bg:transparent;--card:#181A15;--card-2:#11130F;--soft:#11130F;--text:#FFFFFF;--ink:#FFFFFF;--ink-soft:rgba(240,240,237,.80);--ink-faint:rgba(240,240,237,.55);--mut:rgba(240,240,237,.55);--bd:rgba(255,255,255,.12);--line:rgba(255,255,255,.12);--accent:#BEFF74;--accentbg:rgba(190,255,116,.12);--up:#86D69C;--up-bg:rgba(21,128,61,.24);--upbg:rgba(21,128,61,.24);--down:#FCA5A5;--down-bg:rgba(185,28,28,.24);--downbg:rgba(185,28,28,.24);--breach-bg:rgba(185,28,28,.20);--breach-line:rgba(252,165,165,.34);--dx-monet:#FDBA74;--dx-traffic:#9DB6FF;--dx-tech:#B894C2;--growth-bg:rgba(21,128,61,.24);--growth-ink:#86D69C;--mod-bg:rgba(185,28,28,.24);--mod-ink:#FCA5A5;--shadow:0 10px 30px rgba(0,0,0,.28);}' +
    'body{background:transparent!important;font-family:Montserrat,Inter,ui-sans-serif,system-ui,sans-serif!important;color:var(--ink)!important;}' +
    '.wrap{max-width:none!important;padding:0 0 28px!important;}' +
    'h1{font-family:Montserrat,Inter,ui-sans-serif,system-ui,sans-serif!important;font-size:32px!important;font-weight:700!important;letter-spacing:0!important;text-transform:none!important;}' +
    'section,.appcard,.table-card,.banner,.takeaway{border-radius:16px!important;box-shadow:var(--shadow)!important;}' +
